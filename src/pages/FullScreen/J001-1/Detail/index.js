        ...
        >
            ...
            <div className={styles.body}>
                <div >
                    ...
                    <div className={styles.value} >{detailData.planCode}</div>
                </div>
                <div style={{ width:'5rem'}}></div>
                <div >
                    <div className={styles.label} >托盘号：</div>
                    <div className={styles.value} >{detailData.trayNumber}</div>
                </div>
            </div>
            <div className={styles.body}>
                <div >
                    <div className={styles.label} >品号：</div>
                    <div className={styles.value} >{detailData.productNumber}</div>
                </div>
                <div style={{ width:'5rem'}}></div>
                <div >
                    <div className={styles.label} >品名：</div>
                    <div className={styles.value} >{detailData.productName}</div>
                </div>
            </div>
            <div className={styles.body}>
                <div >
                    <div className={styles.label} >原始库位：</div>
                    <div className={styles.value} >{detailData.fromLocation}</div>
                </div>
                <div style={{ width:'5rem'}}></div>
                <div >
                    <div className={styles.label} >目标库位：</div>
                    <div className={styles.value} >{detailData.toLocation}</div>
                </div>
            </div>
        </div>
