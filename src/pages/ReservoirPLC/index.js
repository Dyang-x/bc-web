...
import ReservoirPLCServices from '~/api/ReservoirPLC';
...
const Index = ({ history }) => {
  ...
  const columns = useMemo(() => {
    return [
      ...
      // {
      //   title: getFormattedMsg('ReservoirPLC.title.priority'),
      //   dataIndex: 'priority',
      //   key: 'priority',
      //   align: 'center',
      // },
      // {
      //   title: getFormattedMsg('ReservoirPLC.title.transferCode'),
      //   dataIndex: 'transferCode',
      //   key: 'transferCode',
      //   align: 'center',
      // },
      {
        title: getFormattedMsg('ReservoirPLC.title.orderCode'),
        dataIndex: 'orderCode',
        key: 'orderCode',
        align: 'center',
      },
      // {
      //   title: getFormattedMsg('ReservoirPLC.title.fromLocation'),
      //   dataIndex: 'fromLocation',
      //   key: 'fromLocation',
      //   align: 'center',
      // },
      // {
      //   title: getFormattedMsg('ReservoirPLC.title.middle'),
      //   dataIndex: 'middle',
      //   key: 'middle',
      //   align: 'center',
      // },
      // {
      //   title: getFormattedMsg('ReservoirPLC.title.toLocation'),
      //   dataIndex: 'toLocation',
      //   key: 'toLocation',
      //   align: 'center',
      // },
      // {
      //   title: getFormattedMsg('ReservoirPLC.title.agvState'),
      //   dataIndex: 'agvState',
      //   key: 'agvState',
      //   align: 'center',
      //   render: (text, recoed, index) => {
      ...
      // },
      // {
      //   title: getFormattedMsg('ReservoirPLC.title.transportState'),
      ...
      // },
      {
        ...
        render: (_, record) => [
          nowTab == 1 && [
            ...
            <a key="pause" onClick={() => handlePause(record)}>{getFormattedMsg('ReservoirPLC.button.pause')}</a>,
  ...
  const HandleSaveAdjust = () => {
    ...
    validateFields(async (err, values) => {
      ...
      await ReservoirPLCServices.adjustPriority(adjustModalData.id, params.priority)
        .then(res => {
  ...
  const handlePause = async (record) => {
    await ReservoirPLCServices.suspendTask(record.id)
      .then(res => {
        notification.success({
  ...
  const handleDelete = (record) => {
    Modal.confirm({
      ...
      okType: 'danger',
      onOk: async () => {
        await ReservoirPLCServices.deleteById(record.id)
          .then(res => {
            notification.success({
  ...
  const handleContinue = async (record) => {
    await ReservoirPLCServices.continueTask(record.id)
      .then(res => {
        notification.success({
  ...
  const handleRollback = (record) => {
    Modal.confirm({
      ...
      okType: 'danger',
      onOk: async () => {
        await ReservoirPLCServices.backTask(record.id)
          .then(res => {
            notification.success({
  ...
  const handleComplete = (record) => {
    Modal.confirm({
      ...
      onOk: async () => {
        await ReservoirPLCServices.finishTask(record.id)
          .then(res => {
            notification.success({
