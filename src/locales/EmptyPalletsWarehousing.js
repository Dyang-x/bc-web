...
module.exports = {
  en_US: {
    ...
    title: {
      ...
      creator: 'Creator',
      state: 'state',
      tableName: 'Empty pallets are stored',
      create: 'create',
      update: 'update',
      operation: 'operation',
      ...
      upShelves: 'Confirmed listing?',
      finishOrder: 'Confirm completion of task?',
    },
    message: {
      trayNumber: 'Please input Tray number',
      receiptNumber: 'Please input receipt number',
      ...
      upSuccess: 'Began to success',
      upFailure: 'Began to fail',
      finishSuccess: 'Complete successfully',
      finishFailure: 'Completion failure',
  ...
  zh_CN: {
    ...
    message: {
      ...
      upSuccess: '上架开始成功',
      upFailure: '上架开始失败',
      finishSuccess: '任务完成成功',
      finishFailure: '任务完成失败',
      origin: '请选择起点',
      middle: '请选择中间点',
    },
    button: {
